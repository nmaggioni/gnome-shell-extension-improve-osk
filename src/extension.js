        ...
        let defaultKeysPostMod = [
            ...
            [
                [{
                    label: 'F1',
                    width: 1,
                    keyval: Clutter.KEY_F1
                }, {
                    label: 'F2',
                    width: 1,
                    keyval: Clutter.KEY_F2
                }, {
                    label: 'F3',
                    width: 1,
                    keyval: Clutter.KEY_F3
                }, {
                    label: '⌫',
                    width: 1.5,
                    keyval: Clutter.KEY_BackSpace
                ...
                [{
                    label: 'F4',
                    width: 1,
                    keyval: Clutter.KEY_F4
                }, {
                    label: 'F5',
                    width: 1,
                    keyval: Clutter.KEY_F5
                }, {
                    label: 'F6',
                    width: 1,
                    keyval: Clutter.KEY_F6
                }, {
                    label: '↵',
                    width: 2,
                    keyval: Clutter.KEY_Return,
                ...
                [{
                    label: 'F7',
                    width: 1,
                    keyval: Clutter.KEY_F7
                }, {
                    label: 'F8',
                    width: 1,
                    keyval: Clutter.KEY_F8
                }, {
                    label: 'F9',
                    width: 1,
                    keyval: Clutter.KEY_F9
                }, {
                    label: '?123',
                    width: 3,
                    level: 2,
